    ...
    <section id="about" className="about">
      <div className="container">
        ...
        <p className="about__description max-w-3xl mx-auto">
          ...
          for gaming pretty much the whole day and wanted to do more than that
          and push my limits with it. That’s how I began my journey as a
          Software Engineer.
          <br />
          <br />
          Laying on the bed and learning new technologies and getting up to date
          with new trends and technologies is what I do most of the time. I am a
          well-organized person with my reports and folder structure (even
          though my room is super messy). I have a Software Engineering degree
          but I like to call myself a self-taught developer since 90% of what I
          know is I learned from internet just like everyone else.
          <br />
          <br />
          I have so many human friends but nobody takes the place of ‘Quacky’
          which is a rubber duck that does nothing except stare at me the whole
          time while I code and swear at my computer in random Spanish words
          <br />
          <br />
          ...
          for over 3 years now because that’s probably the only good game I can
          run on my potato PC.
          <br />
          <br />
